...
C
C===============================================================
C   Lines 165-168 commented out - redundant in CROTOR
C   Philip Carter, Esotec Developments, 18 July 11
C===============================================================
C
...
C
C...Commented out for CROTOR
C
C      if(LGW_GEN) then 
C        if(LGW_CHANGED) write(*,1000) X_WIND, Y_WIND
C 1000   format(/1x,'X-window size changed to ',f6.2,'" x',f6.2,'"')
C      endif 
C
